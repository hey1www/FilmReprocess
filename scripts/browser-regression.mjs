...
async function runDesktopFlow(browser) {
  ...
  await page.screenshot({ path: path.join(outputDir, "05-lab-preset.png"), fullPage: true });
  ...
  await page.screenshot({ path: path.join(outputDir, "06-export.png"), fullPage: true });
  ...
  return {
    screenshots: [
      ...
      "03-metadata-applied.png",
      "04-split-adjusted.png",
      "05-lab-preset.png",
      "06-export.png",
    ],
